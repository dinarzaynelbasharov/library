<html>
	...
	?>		
		...
		$result = mysqli_query($db, "SELECT b.name, r.name, bo.borrowdate, bo.returndate, status
        FROM books AS b, borrows AS bo, readers AS r
        WHERE b.book_id = bo.book_id AND r.reader_id = bo.reader_id")or die(mysqli_error($db));	
